...
const terms = [
    ...
    {
        'title': ' Bus Ticket Bookings (Other than UNIV-BUS Smartbus)',
    ...
    {
        'title': ' UNIV-BUS SmartBus Ticket booking',
        'desc': 'User agrees and understands that INODRAILBUS provides a platform to the operator for the purpose of providing the services to the users.<br/><br/> The liability in relation to the use of UNIV-BUS Smartbus service shall be limited to conditions as mentioned in Clause 3.'
    },
    {
        ...
        <React.Fragment>
            ...
            <div className="container mt-90">
                ...
                <p className="mt-30" style={{ color: 'rgba(0,0,0,0.5)', fontSize: '13px', fontWeight: '500' }}>
                    ...
                    Welcome to RailYatri.in and UNIV-BUS.com<br /><br />
                    Stelling Technologies Private Limited and IndoRailBus Travel Private Limited provides access to the RailYatri.in & UNIV-BUS.com website along with RailYatri & UNIV-BUS smartphone app (the "website" or “app”) to You, subject to the conditions set out on this page. Together website and apps are termed as platforms.<br /><br />
                    Please read these conditions carefully before using the website and app. By using the RailYatri and UNIV-BUS platforms, you signify your agreement to be bound by these conditions.<br /><br />
                    The Terms and Conditions of Use is a legal contract between you being, an individual or corporate customer, user, or beneficiary of this service, and Stelling Technologies Private Limited (RailYatri) and IndoRailBus Travel Private Limited (UNIV-BUS), both having its registered office at Amco Towers, A -5,6,7, Amaltash Marg, A Block, Sector 9, Noida, Uttar Pradesh 201301 (RailYatri).<br /><br />
                    ...
                    In addition, when you use any current or future RailYatri.in service, you may also be subject to such additional terms, guidelines and conditions applicable to that RailYatri / UNIV-BUS Service. If these Conditions of Use are inconsistent with such additional Terms, the additional Terms shall  prevail over these term and conditions.<br /><br />
