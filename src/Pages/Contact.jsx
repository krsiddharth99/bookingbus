    ...
    return (
        <React.Fragment>
            ...
            <div className="container shadow-lg pt-50 pb-50 pl-60 pr-60 bg-white" style={{ borderRadius: '10px', position: 'relative', top: '-100px' }}>
                ...
                <p className="mt-20 text-center" style={{ color: 'rgba(0,0,0,0.6)', fontWeight: '500' }}>We are the creators of India’s 1st fleet of branded buses that guarantee safe & hygienic journeys. We’re here to help you solve your queries and provide answers to questions related to IntrCity SmartBus and it’s services.</p>
            ...
            <div className="container-fluid" style={{ backgroundColor: '#F1F2F6' }}>
                <div className="container pt-40 pb-40 pl-50 pr-50">
                    <h2 className="text-center" style={{ color: '#2C3138', fontWeight: 'bold' }}>VitCity SmartBus Lounge - safe & private boarding space for your convenience</h2>
