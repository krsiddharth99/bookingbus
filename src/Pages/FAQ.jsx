        ...
        <React.Fragment>
            ...
            <div className="container-fluid pt-90" style={{ backgroundImage: 'url("/imgs/about/bg.png")', backgroundSize: '100% 100%', height: '280px' }}>
                <div className="container">
                    ...
                    <p className="mt-20" style={{ color: 'rgba(0,0,0,0.7)', fontSize: '14px', fontWeight: '500' }}>UNIV-BUS by RailYatri has become the most preferred UNIV-BUS smart bus fleet. Our branded smart buses with the best possible amenities on-board comply with the highest safety standards. Post lockdown count on us for a 100% hygienic, sanitised and physically distant journey!</p>
                </div>
            </div>
            <div className="container">
